  ...
  return (
    <div className="bg-zinc-100">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-2xl sm:text-3xl font-semibold mb-7 text-blue-900 text-center">
          Our Work
        </h1>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="mb-4">
            <img src={CaseStudy1} alt="Case Study 1" className="w-full h-64 object-cover" />
            ...
            <div className="flex justify-between mt-8 items-center">
              <button className="bg-red-100 text-red-600 px-4 py-2 rounded-full text-xs sm:text-sm">
                Start Ups
              </button>
              <a href="#" className="text-red-600 hover:text-blue-900 flex items-center">
                Read More
                <svg
          ...
          <div className="mb-4">
            <img src={CaseStudy2} alt="Case Study 2" className="w-full h-64 object-cover" />
            <h2 className="text-lg sm:text-xl font-semibold mt-4">
            ...
            <p className="text-sm sm:text-base mt-4">
              ...
              through Feasibility Analysis of over 1,000 Real Estate Assets
          ...
          <div className="mb-4">
            <img src={CaseStudy3} alt="Case Study 3" className="w-full h-64 object-cover" />
            <h2 className="text-lg sm:text-xl font-semibold mt-4">
          ...
          <div className="mb-4">
            <img src={CaseStudy4} alt="Case Study 4" className="w-full h-64 object-cover" />
            <h2 className="text-lg sm:text-xl font-semibold mt-4">
