...
const Navbar = () => {
  ...
  let Links = [
    ...
    {name: "Case Studies 1",  link: "/casestudies"},
    {name: "Case studies 2", link: "/casestudieed" },
  ...
  return (
    <div className="w-full bg-white top-0 left-0">
      <div className="md:flex items-center justify-between py-4 md:px-10 px-7">
        ...
        <ul
          className={`md:flex w-40 pl-5 md:items-center mr-2 md:bg-transparent h-52 md:h-auto bg-white absolute ${
